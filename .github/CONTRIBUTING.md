# Contributing to otoroshi-plugin-spiffe

These guidelines apply to all projects living in the the `cloud-apim/otoroshi-plugin-spiffe` repository.
...
* [src](https://github.com/cloud-apim/otoroshi-plugin-spiffe/src): contains the otoroshi-plugin-spiffe sources and tests
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/cloud-apim/otoroshi-plugin-spiffe/issues) and [existing pull requests](https://github.com/cloud-apim/otoroshi-plugin-spiffe/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/cloud-apim/otoroshi-plugin-spiffe/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/cloud-apim/otoroshi-plugin-spiffe#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline otoroshi-plugin-spiffe.
